...
class AppDelegate: UIResponder, UIApplicationDelegate {
   ...
   func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
      ...
      UINavigationBar.appearance().titleTextAttributes = [
         NSFontAttributeName : UIFont(name: Helper.navTitleFont, size: 20)!,
         NSForegroundColorAttributeName : UIColor(white: 0.3, alpha: 1)
      ]
      
      /*var rect = CGRectMake(0, 0, UINavigationBar.appearance().frame.size.width, 44)
      UIGraphicsBeginImageContextWithOptions(UINavigationBar.appearance().frame.size, false, 0)
   ...
   lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
      ...
      let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Metric.sqlite")
